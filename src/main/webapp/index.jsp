...
<body>
	...
	<h2 style="color: blue; font-size: 40px;" align="center">THIS IS NEXUS TOPIC</h2>
        <h2 style="color: orange; font-size: 40px;" align="center">THIS IS SUNIL AI WORLD</h2>
	<h2 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS</h2>
        <h2 style="color: black; font-size: 40px;" align="center">we stored war file in Nexus</h2>
